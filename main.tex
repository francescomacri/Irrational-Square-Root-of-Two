...
\todo{Adding to the blog that I also will treat the historical aspects of the mathematical concepts presented}

\todo{checking the whole document}
\todo{checking the whole logical steps of each proof}
\todo{Checking the explanation on the M Companion and on the AM Companion}
...
\begin{proof}
    ...
    \todo{checking the formulation of the last part of the proof, i. e. the conclusion, as well as the whole proof and the references}
\end{proof}
